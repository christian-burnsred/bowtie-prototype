...
import {
  controlExpandedGridBoxContentSx,
  controlExpandedGridBoxSx,
} from "./NodeBlock.styles.ts";
...
export const ControlExpandedGridBox = ({
  ...
  return (
    <>
      ...
      >
        <ControlContent
          controlName={expandedControlInRow.controlName}
          onClose={onClose}
        />
      </GridItem>
    </>
...
export const ControlContent = ({
  ...
  return (
    <Box sx={controlExpandedGridBoxContentSx}>
      ...
      <HStack spacing={6} align="start">
        <Box className="control-expanded-column-container">
          ...
          <span className="control-expanded-text">
            To prevent vehicle moving forward or backwards when personnel are on
            the ground next to or within the footprint of a vehicle.
          </span>
          ...
          <span className="control-expanded-text">
            Where persons need to be on ground in the vicinity of a running, but
            stationary vehicle.
          </span>
        </Box>
        <Box className="control-expanded-column-container">
          ...
          <span className="control-expanded-text">
            Implement as part of lifecycle replacement and where available from
            Original Equipment Manufacturer. Alternatively retrofit options
            exist for some vehicle types or Original Equipment Manufacturers as
            part of ground level isolation control station.
          </span>
